...
import FlashCardSchema from "./Validation/CardSchema";
...
import { setFlashCard } from "../../Redux/ReducerSlice/flashcardSlice";
          ...
          <div className="flex flex-col px-10 py-4 bg-white drop-shadow-lg space-y-4 rounded-md">
            ...
            <div className="flex flex-col sm:flex-row items-center space-x-10 pt-3">
              ...
              <div className="flex flex-col relative">
                <h2>Create Group <span className="absolute top-1 ml-2 ">*</span></h2>
                <Field
                  type="text"
                  name="groupname"
            ...
            <div className="flex flex-col w-full sm:w-[70%]">
              <h2 className="mb-1">Add Description</h2>
              <Field
                as="textarea"
                name="groupdescription"
                rows={3}
                className="resize-none border-slate-300 border-2 rounded-md placeholder:opacity-40  focus:border-slate-400"
              />
             <ErrorMessage
                  component={"div"}
                  className="text-sm text-red-500"
